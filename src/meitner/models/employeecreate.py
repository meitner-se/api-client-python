...
class EmployeeCreateExternalTypedDict(TypedDict):
...
class EmployeeCreateExternal(BaseModel):
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the employee placement, the Source-field is not included."""
...
class EmployeeCreateAddressTypedDict(TypedDict):
...
class EmployeeCreateAddress(BaseModel):
    r"""The address of the employee"""
...
class EmployeeCreateTypedDict(TypedDict):
    r"""Request body"""
    ...
    external: NotRequired[EmployeeCreateExternalTypedDict]
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the employee placement, the Source-field is not included."""
    gender: NotRequired[Nullable[EmployeeCreateGender]]
    r"""The gender of the employee"""
    ...
    address: NotRequired[EmployeeCreateAddressTypedDict]
    r"""The address of the employee"""
...
class EmployeeCreate(BaseModel):
    ...
    external: Optional[EmployeeCreateExternal] = None
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the employee placement, the Source-field is not included."""

    gender: OptionalNullable[EmployeeCreateGender] = UNSET
    r"""The gender of the employee"""
    ...
    address: Optional[EmployeeCreateAddress] = None
    r"""The address of the employee"""
