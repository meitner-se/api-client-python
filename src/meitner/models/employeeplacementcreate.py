...
class EmployeePlacementCreateExternalTypedDict(TypedDict):
...
class EmployeePlacementCreateExternal(BaseModel):
    r"""External is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the guardian, the Source-field is not included."""
...
class EmployeePlacementCreateTypedDict(TypedDict):
    r"""Request body"""
...
class EmployeePlacementCreate(BaseModel):
    ...
    external: Optional[EmployeePlacementCreateExternal] = None
    r"""External is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the guardian, the Source-field is not included."""
