...
class StudentUpdateExternalTypedDict(TypedDict):
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""

    source_id: str
    r"""The ID of the external source"""


class StudentUpdateExternal(BaseModel):
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""
...
class StudentUpdateAddressTypedDict(TypedDict):
...
class StudentUpdateAddress(BaseModel):
    r"""The address of the student"""
...
class StudentUpdateTypedDict(TypedDict):
    r"""Request body"""
    ...
    external: NotRequired[StudentUpdateExternalTypedDict]
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""
    gender: NotRequired[Nullable[StudentUpdateGender]]
    r"""The gender of the student"""
    ...
    address: NotRequired[StudentUpdateAddressTypedDict]
    r"""The address of the student"""
...
class StudentUpdate(BaseModel):
    ...
    external: Optional[StudentUpdateExternal] = None
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""

    gender: OptionalNullable[StudentUpdateGender] = UNSET
    r"""The gender of the student"""
    ...
    address: Optional[StudentUpdateAddress] = None
    r"""The address of the student"""
