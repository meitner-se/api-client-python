...
class StudentCreateExternalTypedDict(TypedDict):
...
class StudentCreateExternal(BaseModel):
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""
...
class StudentCreateAddressTypedDict(TypedDict):
...
class StudentCreateAddress(BaseModel):
    r"""The address of the student"""
...
class StudentCreateTypedDict(TypedDict):
    r"""Request body"""
    ...
    external: NotRequired[StudentCreateExternalTypedDict]
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""
    gender: NotRequired[Nullable[StudentCreateGender]]
    r"""The gender of the student"""
    ...
    address: NotRequired[StudentCreateAddressTypedDict]
    r"""The address of the student"""
...
class StudentCreate(BaseModel):
    ...
    external: Optional[StudentCreateExternal] = None
    r"""ExternalRequest is the External-object used on Update and Create operations, since it should only be allowed to set SourceID for the student, the Source-field is not included."""

    gender: OptionalNullable[StudentCreateGender] = UNSET
    r"""The gender of the student"""
    ...
    address: Optional[StudentCreateAddress] = None
    r"""The address of the student"""
